...
CREATE TABLE IF NOT EXISTS reflection_logs (
  id INTEGER PRIMARY KEY AUTOINCREMENT, user_name TEXT NOT NULL, date TEXT NOT NULL, spot TEXT NOT NULL,
  activity TEXT, feeling TEXT, insight TEXT, next_time TEXT,
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(user_name, date, spot)
);
CREATE TABLE IF NOT EXISTS spot_notices (
  id INTEGER PRIMARY KEY AUTOINCREMENT, spot TEXT NOT NULL UNIQUE, notice TEXT NOT NULL,
  updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
CREATE TABLE IF NOT EXISTS closed_dates (
  id INTEGER PRIMARY KEY AUTOINCREMENT, date TEXT NOT NULL, spot TEXT, reason TEXT,
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP, UNIQUE(date, spot)
);
